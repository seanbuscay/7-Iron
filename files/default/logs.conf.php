...
<?php if(realpath(__FILE__)===realpath($_SERVER["SCRIPT_FILENAME"])){header($_SERVER['SERVER_PROTOCOL'].' 404 Not Found');die();}?>
{
        ...
        "files": {
                "apache1": {
                        "display" : "Dev Site Error Log",
                        "path"    : "\/var\/log\/apache2\/dev-error.log",
                        "refresh" : 5,
                        "max"     : 10,
                        "notify"  : true,
                        "format"  : {
                ...
                "apache2": {
                        "display" : "Dev Site Access Log",
                        "path"    : "\/var\/log\/apache2\/dev-access.log",
                        "refresh" : 0,
                        "max"     : 10,
                        "notify"  : false,
                        "format"  : {
                ...
                "apache3": {
                        "display" : "Apache Global Error Log",
                ...
                "apache4": {
                        "display" : "Start Files Error Log",
                        "path"    : "\/var\/log\/apache2\/start-error.log",
                        "refresh" : 5,
                        "max"     : 10,
                        "notify"  : true,
                        "format"  : {
                ...
                "apache5": {
                        "display" : "Apache Global Access Log",
