...
[Simply download the latest 7-Iron Vagrantfile](https://github.com/seanbuscay/7-Iron/releases/download/<%= reltag %>/Vagrantfile) to the directory where you want to run the 7-Iron Vagrant Box.
